...
CREATE PROC Instsubjectlimits @Sid INT, @L NVARCHAR (50)
AS
BEGIN TRY
...
CREATE PROC Updaresubjectlimits @Sid INT, @L NVARCHAR(50)
AS
BEGIN TRY
...
AS
BEGIN
	DECLARE @Tn NVARCHAR(35)
	SELECT @Tn=Tutorname FROM inserted 
	IF @Tn NOT IN ('Rahmatullah Muzahid', 'Kaiser Faisal','MD Ahmed' )
	BEGIN
